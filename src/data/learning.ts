...
export const learningData: LearningData = {
  ...
  schoolBlock: {
    ...
    highlight: [
      "系统化学习项目、工程、运营管理经典理论与方法",
      "补足定量分析、模型分析与决策能力",
      "关注人工智能等技术前沿，将课堂输入转化为产品判断与项目实践"
    ]
  },
  ...
  practiceBlock: {
    title: "课余活动与实践",
    description:
      "持续通过论坛、学术活动、校园实践和行业分享拓展输入来源，让认知更新不局限于课堂，而是不断连接真实行业与产品场景。"
  },
  ...
  practiceActivities: [
    ...
    },
    {
      ...
      image: "/images/learning/class.jpg",
      category: "class"
    },
    {
      id: "campus-practice",
    ...
    },
    {
      ...
      image: "/images/growth/guest-sharing.png",
      category: "sharing"
    }
  ]
};
